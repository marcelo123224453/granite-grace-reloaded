...
const items: { img: string; type: string; cats: Cat[]; desc: string }[] = [
  ...
  { img: nOld10, type: "Nagrobek podwójny",        cats: ["podwojne"],                                    desc: "nr, 2" },
  { img: nOld6,  type: "Naprawa/Renowacja",        cats: ["Naprawy/Renowacja"],                           desc: "nr, 3" },
  { img: nOld7,  type: "Nagrobek dziecięcy",       cats: ["dzieciece"],                                   desc: "nr, 4" },
  { img: nOld8,  type: "Naprawa/Renowacja",        cats: ["Naprawy/Renowacja"],                           desc: "nr, 5" },
