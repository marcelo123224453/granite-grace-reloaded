...
const reviews = [
  ...
  { name: "Karolina Gorbacz", text: "Serdecznie polecam firmę Nagrobex i pana Kamila. Profesjonalne wykonanie nagrobka i płyt wokół niego, bardzo dobry kontakt oraz fachowe doradztwo na każdym etapie realizacji. Pan Kamil zawsze odpowiadał na pytania, służył pomocą i wykazał się dużą elastycznością. Rzetelna firma, terminowa realizacja i wysoka jakość wykonania. Dziękuję i polecam." },
  { name: "Izabela", text: "Jestem bardzo zadowolona z wykonanej renowacji nagrobka. Prace zostały przeprowadzone starannie, z dbałością o każdy detal i z dużym szacunkiem dla miejsca pamięci. Efekt końcowy przerósł moje oczekiwania – nagrobek wygląda jak nowy. Profesjonalna obsługa, terminowa realizacja i bardzo dobry kontakt. Z pełnym przekonaniem polecam tę firmę." },
  { name: "Kasia A", text: "Polecam zwłaszcza przy projektach niestandardowych. Wspaniały kontakt z właścicielem. Ludzkie podejście i przystępne ceny. Na każdym etapie projektu byłam informowana na bieżąco. Bardzo dziękuję za pomoc." },
  { name: "Wera :D", text: "Polecam firmę NAGROBEX. Jestem bardzo zadowolona z wykonanego pomnika. Wszystko zostało zrealizowane profesjonalnie, solidnie i zgodnie z ustaleniami. Obsługa była na wysokim poziomie, a pan, który mnie obsługiwał, był bardzo miły, pomocny i życzliwy." },
];
